<template>
    <div class="app-container">
        ...
        <TableCard>
            ...
            <el-table :border="Global.tableShowBorder" v-loading="loading" :data="customerList" @selection-change="handleSelectionChange">
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['crm:customer:edit']">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item command="handleClaim" icon="el-icon-user" v-hasPermi="['crm:customer:edit']">认领</el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                    </template>
                </el-table-column>
...
<script>
import {listCustomer,getCustomer,addCustomer,updateCustomer,delCustomer,claimCustomer} from "@/api/crm/customer";
    ...
    methods: {
        ...
        handleClaim(row) {
            ...
            that.$modal.confirm('是否确认认领该客户？').then(function () {
                ...
                return claimCustomer(that.form);
            }).then(() => {
                that.getList();
