    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
            ...
            <el-form-item label="客户名称" prop="clueName">
                <el-input v-model="queryParams.clueName" placeholder="请输入线索用户名称" clearable @keyup.enter.native="handleQuery"/>
            </el-form-item>
        ...
        <TableCard>
            <el-row :gutter="10" class="mb8">
                <el-col :span="1.5">
                    <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['crm:clue:add']">
                        新增
                    </el-button>
                </el-col>
                <!-- <el-col :span="1.5">
                    <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate" v-hasPermi="['crm:clue:edit']">
                        修改
                    </el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['crm:clue:remove']">
                        删除
                    </el-button>
                </el-col> -->
                <el-col :span="1.5">
                    <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['crm:clue:export']">
                        导出
                    </el-button>
                </el-col>
            ...
            <el-table :border="Global.tableShowBorder" v-loading="loading" :data="clueList" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template slot-scope="scope">
                        <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['crm:clue:edit']">
                            修改
                        </el-button>
                        <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['crm:clue:remove']">
                            删除
                        </el-button>
                        <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['crm:clue:edit']">
                            <span class="el-dropdown-link">
                              <i class="el-icon-d-arrow-right el-icon--right"></i>更多
                            </span>
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item command="handleClaim" icon="el-icon-user" v-hasPermi="['crm:clue:edit']">认领</el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                    </template>
                </el-table-column>
...
<script>
import {listClue,getClue,addClue,updateClue,delClue,claimClue} from "@/api/crm/clue";
...
export default {
    ...
    methods: {
        ...
        handleClaim(row) {
            const that = this;
            that.$modal.confirm('是否确认认领该客户？').then(function () {
                that.reset();
                that.form.clueId = row.clueId;
                return claimClue(that.form);
            }).then(() => {
                that.getList();
                that.$modal.msgSuccess("认领成功");
            }).catch((error) => {
