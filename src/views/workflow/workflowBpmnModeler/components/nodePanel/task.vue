...
export default {
        ...
        item: [
          ...
          },
          {
          ...
          },
            {
                ...
                activeText: '是',
                inactiveText: '否',
                show: !!_this.showConfig.useVars
            },
            {
                xType: 'input',
                name: 'vars',
                label: '流程变量',
                show: !!_this.showConfig.vars && _this.formData.useVars == true
            },
          {
            xType: 'select',
            name: 'assignee',
            ...
            show: !!_this.showConfig.assignee && _this.formData.userType === 'assignee' && _this.formData.useVars != true
          },
          {
            xType: 'select',
            name: 'candidateUsers',
            ...
            filterable: true,
            dic: { data: _this.users, label: 'name', value: 'id' },
            show: !!_this.showConfig.candidateUsers && _this.formData.userType === 'candidateUsers' && _this.formData.useVars != true
          },
          {
            xType: 'select',
            ...
            show: !!_this.showConfig.candidateGroups && _this.formData.userType === 'candidateGroups' && _this.formData.useVars != true
          },
          {
            xType: 'slot',
            name: 'multiInstance',
  ...
  watch: {
      'formData.useVars': function(val,oldVal){
          console.log("是否使用流程变量："+val+"， "+oldVal);
          ...
          let v = val?'1':'0';
          this.updateProperties({ 'flowable:useVars': v })
      },
      'formData.vars': function(val,oldVal){
          if (this.formData.userType == 'assignee') {
              this.updateProperties({ 'flowable:assignee': val })
          }else if(this.formData.userType == 'candidateUsers'){
              this.updateProperties({ 'flowable:candidateUsers': val })
          }else if(this.formData.userType == 'candidateGroups'){
