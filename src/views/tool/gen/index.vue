<template>
    <div class="app-container">
        ...
        <TableCard>
            ...
            <el-table :border="Global.tableShowBorder" v-loading="loading" :data="tableList" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="表名称" align="center" prop="tableName" :show-overflow-tooltip="true" width="340"/>
                <el-table-column label="表描述" align="center" prop="tableComment" :show-overflow-tooltip="true"/>
                <el-table-column label="实体" align="center" prop="className" :show-overflow-tooltip="true" width="260"/>
    ...
    methods: {
        ...
        handleGenTable(row) {
            ...
            if (row.genType === "1") {
                ...
                this.$download.zip("/tool/gen/batchGenCode?tables=" + tableNames, "fno");
            }
        },
        /** 同步数据库操作 */
        handleSynchDb(row) {
