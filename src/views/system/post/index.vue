<template>
    <div class="app-container">
        ...
        <TableCard>
            ...
            <el-table :border="Global.tableShowBorder" v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
                <el-table-column type="selection" width="55" align="center"/>
                <el-table-column label="职位编号" align="center" prop="postId" width="120"/>
                <el-table-column label="职位编码" align="center" prop="postCode"/>
                <el-table-column label="职位名称" align="center" prop="postName"/>
                <el-table-column label="职位排序" align="center" prop="postSort" width="120"/>
