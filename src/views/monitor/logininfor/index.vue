<template>
    <div class="app-container">
        ...
        <TableCard>
            ...
            <el-table :border="Global.tableShowBorder" ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
