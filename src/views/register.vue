    ...
    <div class="register">
        <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
            ...
            <el-form-item prop="tenantName">
                <el-input v-model="registerForm.tenantName" type="text" auto-complete="off" placeholder="公司">
        ...
        <div class="el-register-footer">
            <span>Copyright © 2022-2023 dianshixinxi.com All Rights Reserved.</span>
        </div>
    </div>
</template>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            registerRules: {
                tenantName: [
                    {required: true, trigger: "blur", message: "请输入您的公司帐号"},
                ],
                username: [
...
.register {
    ...
    align-items: center;
    height: 100%;
    background-image: url("../assets/images/bg/bg-img-3.jpg");
